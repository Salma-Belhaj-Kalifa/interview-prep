        ...
        <div className="text-[14px] prose prose-slate dark:prose-invert max-w-none">
            <ReactMarkdown
                ...
                components={{
                    ...
                    blockquote({children}) {
                        return <blockquote className="border-1-4 border-gray-200 pl-4 italic my-4"></blockquote>
                    },
                    h1({ children }) { 
                    ...
                    th({ children }) {
                        return <th className="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"></th>
                    },
                    td({ children }) {
